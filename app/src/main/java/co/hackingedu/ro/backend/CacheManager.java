...
public class CacheManager {
    ...
    public String JSON_LONG_PRIZES_STRING = "[{\"description\":\"TBA\",\"sponsor\":\"HackingEDU\",\"prizeName\":\"HackingEDU EDTech Champions\"},{\"description\":\"TBA\",\"sponsor\":\"HackingEDU\",\"prizeName\":\"HackingEDU Followup Winners\"},{\"description\":\"1 year of free textbooks, 1 year of Chegg Study (Textbook Solutions) & 4 hours of Tutoring with Chegg Tutors (for each team member)\",\"sponsor\":\"Chegg\",\"prizeName\":\"Best use of Chegg API\"},{\"description\":\"TRIP TO NYC for top team to Present Hack at Ignite Disrupt Edtech Conference, One year of Wolfram Programming Cloud Developer Level, One year of Wolfram Mathematica Online, One year of Wolfram|Alpha Pro for everyone on those teams\",\"sponsor\":\"Wolfram\",\"prizeName\":\"Best use to the Wolfram Technologies\"},{\"description\":\"Finalist Position for KPCB Fellowship Position\",\"sponsor\":\"KPCB\",\"prizeName\":\"#SocialGoodHack KPCB\"},{\"description\":\"$4000\",\"sponsor\":\"IBM\",\"prizeName\":\"Best Use of IBM Bluemix\"},{\"description\":\"$4000\",\"sponsor\":\"Target\",\"prizeName\":\"Best Use of Target API\"},{\"description\":\"$150 of Namecheap credits.: creativity & authenticity of domain name\",\"sponsor\":\"NameCheap\",\"prizeName\":\"NameCheap Best Domain Main Prize\"},{\"description\":\"Pebble Times for top 2 teams\",\"sponsor\":\"Pebble\",\"prizeName\":\"Coolest Pebble Hack! (2)\"},{\"description\":\"4 Myos for Top team\",\"sponsor\":\"Thalmic Labs\",\"prizeName\":\"#bestuseofMYO\"},{\"description\":\"Sennheiser Game One headsets (for each team member)\",\"sponsor\":\"Dolby\",\"prizeName\":\"Best use of Dolby (Usage of our technology (base on useful and creativity))\"},{\"description\":\"$100 gift cards (google play, itunes)\",\"sponsor\":\"GlobalCommit\",\"prizeName\":\"GlobalCommit: Social Good Award\"},{\"description\":\"Apple Watches for the Team\",\"sponsor\":\"Automattic\",\"prizeName\":\"Automattic Social Good Prize\"},{\"description\":\"$5000: Criteria for challenge: 1) sign-up for Cloud Account and enter promo code, 2) use Clusterpoint as back-end solution for your app, 3) relative degree of Clusterpoint utilization\",\"sponsor\":\"Clusterpoint\",\"prizeName\":\"Best use of Clusterpoint\"},{\"description\":\"First Prize: $1,000 Amazon Gift Card+Interview with Rubicon Project, Second Prize: $500 Amazon Gift Card+Interview with Rubicon Project, Third Prize (2 count): $250 Amazon Gift Card each + Interviews with Rubicon Project\",\"sponsor\":\"Rubicon Project\",\"prizeName\":\"Rubicon:Bring your Javascript, app development and big data experience and automate advertising\"},{\"description\":\"Keyboards for members of the team\",\"sponsor\":\"Braintree\",\"prizeName\":\"Best use of Braintree API\"},{\"description\":\"Hosted lunch with the CEO of WikiHow\",\"sponsor\":\"WikiHow\",\"prizeName\":\"Design the Future of WikiHow\"},{\"description\":\"Raspberry Pi 2s for each team member\",\"sponsor\":\"Linode\",\"prizeName\":\"Best Use of Linode\"},{\"description\":\"Leap Motion for everyone on the top 2 Teams\",\"sponsor\":\"Leap Motion\",\"prizeName\":\"Best Leap Motion Hack (2)\"},{\"description\":\"$500\",\"sponsor\":\"Twist\",\"prizeName\":\"Best Use of Twist\"},{\"description\":\"Wearable sleeping bag suit\",\"sponsor\":\"Twilio\",\"prizeName\":\"Best use of Twilio API\"},{\"description\":\"$1000\",\"sponsor\":\"Moxtra\",\"prizeName\":\"Best Collaboration Hack using Moxtra SDK/API\"}]";
    ...
    public String getJsonString(String JsonFile, Context _context){
        ...
        else if(JsonFile == PRIZES_FILE){
            str = getSharedPreferences(_context).getString(JsonFile, JSON_LONG_PRIZES_STRING);
        }
        else{
